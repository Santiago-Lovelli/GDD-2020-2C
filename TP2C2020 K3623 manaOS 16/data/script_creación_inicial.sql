...
SET IDENTITY_INSERT [GD2C2020].[manaOS].[TipoAuto] ON  
GO

INSERT INTO [GD2C2020].[manaOS].[TipoAuto]
	([TIPO_AUTO_CODIGO]
	,[TIPO_AUTO_DESC])
	SELECT m.[TIPO_AUTO_CODIGO]
		,m.[TIPO_AUTO_DESC]
	FROM [GD2C2020].[gd_esquema].[Maestra] m
	WHERE m.[TIPO_AUTO_CODIGO] IS NOT NULL
		  AND m.[TIPO_AUTO_DESC] IS NOT NULL
	GROUP BY m.[TIPO_AUTO_CODIGO]
		,m.[TIPO_AUTO_DESC]
	ORDER BY m.[TIPO_AUTO_CODIGO]
		,m.[TIPO_AUTO_DESC]
GO

SET IDENTITY_INSERT [GD2C2020].[manaOS].[TipoAuto] OFF  
GO
--Auto
