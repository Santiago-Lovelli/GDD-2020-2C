...
INSERT INTO [GD2C2020].[manaOS].[Cliente]
	...
	SELECT [FAC_CLIENTE_APELLIDO]
		...
		,[FAC_CLIENTE_MAIL]
	FROM [GD2C2020].[gd_esquema].[Maestra]
	JOIN [GD2C2020].[manaOS].[Cliente] c ON NOT(c.[CLIENTE_NOMBRE] = [FAC_CLIENTE_NOMBRE] AND C.[CLIENTE_APELLIDO] = [FAC_CLIENTE_APELLIDO] AND c.[CLIENTE_DNI] = [FAC_CLIENTE_DNI])
